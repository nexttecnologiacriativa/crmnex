...
BEGIN
    ...
    -- Não remover workspace_members nem o workspace em si, apenas os dados
...
-- Aplicar triggers de updated_at nas tabelas que têm essa coluna
...
-- Índices adicionais importantes que estavam faltando
...
-- Habilitar realtime em tabelas principais
