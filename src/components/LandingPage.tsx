...
const LandingPage = () => {
  ...
  const benefits = ["Organize todos os seus leads em um só lugar", "Acompanhe cada etapa do funil de vendas", "Integre com suas ferramentas favoritas", "Trabalhe em equipe de forma sincronizada", "Acesse de qualquer lugar, a qualquer hora"];
  const steps = [{
    icon: Target,
    title: "Capture Leads",
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center gap-4">
              <Button onClick={handleLoginClick} variant="outline" className="border-2 border-[#003366] text-[#003366] hover:bg-[#003366] hover:text-white rounded-xl px-6 py-5 font-semibold transition-all">
                Login
              </Button>
              <Button onClick={handleCTAClick} className="bg-[#A4D65E] hover:bg-[#8FC14E] text-white rounded-xl px-8 py-6 text-base font-semibold shadow-lg hover:shadow-xl transition-all">
                Cadastrar
          ...
          {isMenuOpen && <div className="md:hidden py-6 border-t border-gray-100">
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              <Badge className="bg-[#A4D65E]/20 text-[#003366] hover:bg-[#A4D65E]/30 mb-6 text-sm px-4 py-2 font-medium">✨ O CRM Nº1</Badge>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
                <Button size="lg" onClick={handleCTAClick} className="bg-[#A4D65E] hover:bg-[#8FC14E] text-white px-10 py-7 text-lg font-semibold shadow-lg hover:shadow-xl rounded-xl transition-all">
                  Começar Agora
                  <ArrowRight className="ml-3 h-6 w-6" />
                </Button>
                <Button size="lg" onClick={handleLoginClick} variant="outline" className="border-2 border-[#003366] text-[#003366] hover:bg-[#003366] hover:text-white px-10 py-7 text-lg font-semibold rounded-xl transition-all">
                  Ver Demo
                </Button>
              </div>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-10">
              <Button size="lg" onClick={handleCTAClick} className="bg-[#A4D65E] hover:bg-[#8FC14E] text-white px-12 py-8 text-xl font-bold shadow-2xl rounded-xl transition-all">
